...
const HomeBlock = ({ title, description, fullWidth, subTitle }: HomeBlockProps) => {
    ...
    return (
        <div className={`flex flex-col justify-between p-6 bg-white rounded-xl shadow-sm col-span-1 row-span-1
        ${fullWidth ? 'md:col-span-2 md:row-span-2' : 'md:col-span-1 md:row-span-1'}`}>
